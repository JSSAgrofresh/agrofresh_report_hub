...
/* Laboratorios, categorías analíticas y analitos salieron de acá: ahora se
   mantienen dentro de la ficha de cada laboratorio, en Administración →
   Laboratorios. Esta vista quedó con lo que es propio del formulario de
   solicitud y no de un laboratorio en particular. */
type Pestana = 'campos' | 'tiposAplicacion' | 'camposTipoAplicacion' | 'lineasProceso' | 'productos'
  ...
  return (
    <div>
      <Header
        ...
        description="Campos del formulario, tipos de aplicación, líneas de proceso y productos. Los analitos y contactos de cada laboratorio se configuran en Administración → Laboratorios."
      />
